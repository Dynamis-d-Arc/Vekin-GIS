    ...
    <main className="app-shell urban-shell">
      ...
      <section className="urban-dashboard">
        ...
        <section className="urban-grid">
          ...
          <article className="urban-card grid-details-card">
            <h2>Selected Grid Details</h2>
            <div className="grid-data-list">
              ...
              <span className="cover-mix-field">Cover mix <strong id="grid-cover-mix">0</strong></span>
            </div>
          </article>
